						...
						<form action="#" class="c-simpleForm">
							<ul>
								<li class="u-fw100 liSelect">
									<label for="formId_list">Estado</label>
									<div>
										<select name="estado" id="formId_estado" class="field" required>
											<option value="">Selecione</option>
											<option value="s1">Seguradora</option>
											<option value="s2">Seguradora</option>
											<option value="s3">Seguradora</option>
										</select>
									</div>
								</li>
							</ul>
				...
				<li class="u-fw35">
					<div class="s-support__searchResult">
						...
						<ul>
							...
							<li>
								<span class="label">Vidros:</span>
								<span class="caption">0800 70 111 70</span>
							</li>
							<li>
								<span class="label">Países do Mercosul:</span>
								<span class="caption">00 55 11 4331 5126</span>
							</li>
						</ul>
					</div>
				</li>
